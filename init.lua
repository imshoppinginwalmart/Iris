        ...
        Tab = function()
            ...
            do
                ...
                do
                    ...
                    Iris.TabBar()
                    do
                        Iris.Tab({ "\240\159\141\142", true }, { isOpened = a })
                        do
                            Iris.Text({ "Who loves apples?" })
                        ...
                        Iris.End()
                        Iris.Tab({ "\240\159\165\166", true }, { isOpened = b })
                        do
                            Iris.Text({ "And what about broccoli?" })
                        ...
                        Iris.End()
                        Iris.Tab({ "\240\159\165\149", true }, { isOpened = c })
                        do
                            Iris.Text({ "But carrots are the best." })
...
return function(Iris: Types.Internal)
    ...
    require(script.Table)(Iris, widgets)
                ...
                Children = {
                    {
                        Closure = function() local Types = require(script.Parent.Parent.Types)
...
return {}
            ...
            {
                Closure = function() local TemplateConfig = {
...
return TemplateConfig
            ...
            {
                Closure = function() local WidgetTypes = require(script.Parent.WidgetTypes)
...
return {}
            ...
            {
                Closure = function() local HttpService: HttpService = game:GetService("HttpService")
